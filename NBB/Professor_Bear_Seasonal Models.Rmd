...
_NOTE: It's your choice to submit EITHER Lesson 04 (Seasonal Models) OR Lesson 05 (Spectral Analysis) for the module Time Series Analysis 2._   
  ...
  Answer the following questions:   
    ...
    * If (and only if) you can't use some form of Time series analysis help in your research project then apply a form of Time series Seasonal Models to a data set you find at the [UC Irvine Machine Learning Repository](http://archive.ics.uci.edu/ml/)  

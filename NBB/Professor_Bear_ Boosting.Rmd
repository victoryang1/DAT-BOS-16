...
To run the code in M09_Lesson_03.Rmd you may need additional packages.
...
# Assingment
  ...
  Answer the following questions:    
    * Can some form of Boosting help in your research project?    
    * If it can apply Boosting to your research project? Does it help?       
    * If (and only if) you can't use some form of Boosting help in your research project then apply a form of Boosting to the data set you chose for the supervised learning module. Does it help?       

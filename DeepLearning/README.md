# Deep Learning & TensorFlow  links

## What is Deep Learning?

Deep learning (also known as deep structured learning, hierarchical learning or deep machine learning) is the study of artificial neural networks and related machine learning algorithms that contain more than one hidden layer. These deep nets:[1]
...
TensorFlow is used for machine learning across a range of tasks, and developed by Google to meet their needs for systems capable of building and training neural networks to detect and decipher patterns and correlations, analogous to the learning and reasoning which humans use.[3] It is currently used for both research and production at Google products,‍[3]:min 0:15/2:17 [4]:p.2 [3]:0:26/2:17 often replacing the role of its closed-source predecessor, DistBelief. TensorFlow was originally developed by the Google Brain team for internal Google use before being released under the Apache 2.0 open source license on November 9, 2015.
...
<a name="deep-learning-tutorials" />
* [MIT 6.S191 Lecture 1: Intro to Deep Learning ](http://introtodeeplearning.com/) - A 1-week extensive survey of deep learning methods and applications.  
* [MIT 6.S191 Lecture 1: Intro to Deep Learning YouTube lectures ](https://www.youtube.com/watch?v=IgSuFYamZas) - [MIT 6.S191 Lecture 1: Intro to Deep Learning YouTube lectures. A 1-week extensive survey of deep learning methods and applications.  
